...
class EnhancedBatteryAnalyticsDashboard(param.Parameterized):
    ...
    def load_data(self):
        ...
        try:
            ...
            if not self.data.empty:
                ...
                self.data = self.data.resample(self.aggregation_interval).agg({
    ...
    def power_plot(self):
        ...
        interval_label = self.param.aggregation_interval.objects.get(self.aggregation_interval, self.aggregation_interval)
