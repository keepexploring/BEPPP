...
class EnhancedBatteryAnalyticsDashboard(param.Parameterized):
    ...
    def view(self):
        ...
        min_capacity_slider = pn.widgets.IntSlider(
            name='Min Capacity',
            start=0,
            end=10000,
            step=500,
        ...
        min_capacity_slider.link(self, value='min_capacity')

        max_capacity_slider = pn.widgets.IntSlider(
            name='Max Capacity',
            start=0,
            end=10000,
            step=500,
        ...
        max_capacity_slider.link(self, value='max_capacity')
