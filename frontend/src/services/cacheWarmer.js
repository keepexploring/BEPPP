...
export function getEndpointsForHub (hubId, isAdmin) {
  const endpoints = [
    ...
    '/battery-rentals',
    '/battery-rentals?status=active',
    `/battery-rentals?status=active&hub_id=${hubId}`,
    '/pue-rentals',
    '/pue-rentals?status=active',
    `/pue-rentals?status=active&hub_id=${hubId}`,
    '/rentals/',
